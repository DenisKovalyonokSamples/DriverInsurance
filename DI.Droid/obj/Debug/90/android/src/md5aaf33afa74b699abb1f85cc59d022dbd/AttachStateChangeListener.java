...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DI.Droid.Extensions.AttachStateChangeListener, DI.Droid", AttachStateChangeListener.class, __md_methods);
	}
	...
	public AttachStateChangeListener ()
	{
		...
		if (getClass () == AttachStateChangeListener.class)
			mono.android.TypeManager.Activate ("DI.Droid.Extensions.AttachStateChangeListener, DI.Droid", "", this, new java.lang.Object[] {  });
	}
